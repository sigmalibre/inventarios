...
class DETReport
{
    ...
    public function run($year)
    {
        ...
        foreach ($listaProductos as $p) {
            ...
            $linea .= mb_substr(str_pad(sprintf('%0.0f', $p['Cantidad'] * 10000000000), 22, ' ', STR_PAD_LEFT), 0, 22);
            $linea .= mb_substr(str_pad(sprintf('%0.0f', $p['CostoActual'] * 10000000000), 24, ' ', STR_PAD_LEFT), 0, 24);
            $linea .= mb_substr(str_pad(sprintf('%0.0f', $p['Cantidad'] * $p['CostoActual'] * 10000000000), 24, ' ', STR_PAD_LEFT), 0, 24);
            $linea .= ' ';
